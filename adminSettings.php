                ...
                <div class="flex flex-col justify-start ml-8 mt-60" id="maintainSide">
                    ...
                    <div class="flex items-center mb-2 ">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
                          ...
                          <h1 class="ml-3">  <a href="UserList.php">User</a></h1>
                    </div>
                    ...
                    <div class="flex items-center mb-2">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
                          ...
                          <h1 class="ml-3"><a href="postApproval.php">Post Approval</a></h1>
                        </a>
                            ...
                            <li>
                                <a href="" class="flex items-center space-x-1">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4">
                                      ...
                                      <h1 class="text-sm "> <a href="postApproveList.php">List</a></h1>
                                    </a>
                            </li>
                          </ul>
                    </div>
