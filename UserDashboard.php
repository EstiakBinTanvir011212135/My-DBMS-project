            ...
            <div class="" id="mainDIV" style=" visibility: hidden;">
                ...
                <div class="flex flex-col items-center p-5" >
                    ...
                    <div class="flex items-center space-x-7" id="titleBar">
                        ...
                        <h1 class="uppercase font-thin text-2xl border-b  border-slate-500">  <a href="UserDashboard.php">TrackNback</a></h1>
                    ...
                    <a href="" class="hover:text-orange-500 transition-all ease-in-out">
                        <div class="flex items-center mb-2 ">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
                              ...
                              <h1 class="ml-3 "><a href="UserDashboard.php">Profile</a></h1>
                        </div>
                    </a>
                ...
                <div class="flex flex-col justify-start ml-8 mt-10" id="Categobar">
                    ...
                    <div class=" mb-2 ">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
                          ...
                          <h1 class="ml-3"><a href="UserSettings.php">Settings</a></h1>
