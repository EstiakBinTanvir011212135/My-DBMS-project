...
<body>
    <section class="bg-gray-50 dark:bg-gray-900" style="font-family: 'Montserrat', sans-serif; ">
        ...
        <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
            <a href="landing.php" class="flex items-center mb-6 text-2xl font-semibold text-gray-900 dark:text-white">
            ...
            <div class="flex w-full justify-center">
                <div class="">
                    <img src="imgs/black full logo.png" alt="" class="aspect-square object-cover w-[42rem] ">
